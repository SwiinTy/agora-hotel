...
import { Wifi, Moon, UtensilsCrossed, MapPin } from "lucide-react"; 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-20 flex flex-col lg:flex-row justify-between items-center gap-12">
        <div className="max-w-2xl text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="flex gap-4">
              {/* Telegram - Orijinal Renk */}
              <a href="https://t.me/AgoraHotel" target="_blank" className="w-12 h-12 rounded-full bg-[#26A5E4] flex items-center justify-center hover:scale-110 transition-transform shadow-lg border border-white/10">
                <img src="https://cdn.simpleicons.org/telegram/white" className="w-6 h-6" alt="Telegram" />
              </a>
              {/* Facebook - Orijinal Renk */}
              <a href="https://www.facebook.com/profile.php?id=61571114631315" target="_blank" className="w-12 h-12 rounded-full bg-[#1877F2] flex items-center justify-center hover:scale-110 transition-transform shadow-lg border border-white/10">
                <img src="https://cdn.simpleicons.org/facebook/white" className="w-6 h-6" alt="Facebook" />
              </a>
              {/* Instagram - Gradyan Efekti */}
              <a href="https://www.instagram.com/agora.apart.hotel" target="_blank" className="w-12 h-12 rounded-full bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] flex items-center justify-center hover:scale-110 transition-transform shadow-lg border border-white/10">
        ...
        <div className="hidden lg:block w-80 bg-white/10 backdrop-blur-xl p-4 rounded-2xl border border-white/20 shadow-2xl">
          ...
          <div className="h-40 rounded-xl overflow-hidden mb-3 grayscale hover:grayscale-0 transition-all duration-700">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3197.6896!2d31.9863!3d36.5458!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzbCsDMyJzQ0LjkiTiAzMcKwNTknMTAuNyJF!5e0!3m2!1str!2str!4v1620000000000!5m2!1str!2str" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              loading="lazy"
